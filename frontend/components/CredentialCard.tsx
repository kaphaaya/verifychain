    ...
    <div style={{ display: "flex", flexDirection: "column" as const, alignItems: "flex-start", gap: 12 }}>
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 40px rgba(0,212,255,0.12), 0 0 80px rgba(0,68,255,0.08), inset 0 0 60px rgba(0,212,255,0.03)",
          overflow: "hidden",
      ...
      >
        ...
        <div style={{
          ...
          justifyContent: "space-between", marginBottom: 22, position: "relative", zIndex: 1,
        }}>
          {/* Logo */}
        ...
        <div style={{
          ...
          {[
            { l: "TOKEN ID",    v: data.tokenId ? `#${String(data.tokenId).padStart(3,"0")}` : "—" },
        ...
        <div style={{
          ...
          <div style={{ fontFamily: "monospace", fontSize: 11, color: "rgba(160,180,220,0.45)", letterSpacing: "0.04em" }}>
            {shortWallet}
          </div>
          <div style={{
            display: "flex", alignItems: "center", gap: 5,
            fontSize: 10, color: "rgba(160,180,220,0.35)", fontFamily: "monospace",
          }}>
